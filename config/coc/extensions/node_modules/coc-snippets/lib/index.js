...
const vscode_languageserver_types_1 = __webpack_require__(5);
const vscode_uri_1 = __importDefault(__webpack_require__(6));
...
const vscode_uri_1 = __importDefault(__webpack_require__(6));
const os_1 = __importDefault(__webpack_require__(18));
...
class UltiSnippetsProvider extends baseProvider_1.default {
    ...
    async init() {
        ...
        if (this.pythonCode) {
            let { nvim } = coc_nvim_1.workspace;
            let tmpfile = path_1.default.join(os_1.default.tmpdir(), `coc-ultisnips-${process.pid}.py`);
